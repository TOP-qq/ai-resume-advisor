...
任务：
1. 推荐公司：全球范围（创业/外企/独角兽/隐形冠军，不只推大厂）推荐1家最匹配的，名称+理由60字内。必须基于简历细节，差异化推荐。
...
根据简历生成5道定制面试题，覆盖技术深度、项目经验、行为能力，要针对性，不出泛泛通用题。每题：题目、考察重点（一句话）、参考答案（150字左右结合简历背景）、难度（初级/中级/高级）。
